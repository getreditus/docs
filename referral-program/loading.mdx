...
window.gr("loadReferralWidget", {
  ...
  lang: "fr", // Optional. Defaults to English. See "Languages".
  user_details: {
...
| `lang`                      | string | **Optional.** The display language for the widget interface. Defaults to `en` (English). Supported values: `en`, `fr`, `es`, `de`, `pt`, `it`, `pl`. See [Languages](./languages) for details.                       |
